		...
		<div className="p-2 bg-gray-300 rounded-lg flex gap-2">
			...
			<div className="flex justify-between w-full">
				<div className="flex flex-col max-w-[150px]">
					...
					<span className="text-sm text-gray-500">id: {order.product_id}</span>
				</div>

				<div className="flex flex-col max-w-[200px] mr-2">
					<h1 className="font-bold text-xl mb-1">Customer Details</h1>
					<span className="font-normal text-xl">{order.customer_name}</span>
					<span className="text-gray-700 whitespace-normal">{order.customer_email}</span>
					<span className="text-sm text-gray-500">{order.customer_mobile}</span>
				</div>
