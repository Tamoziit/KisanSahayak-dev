		...
		<div>
			...
			{enrolledUser ? (
				<>
					...
					<div className="w-full flex justify-center items-center gap-8 mt-10 p-8">
						<div className="flex flex-col items-center justify-center gap-6 bg-green-300 rounded-lg p-3 backdrop-blur-xl backdrop-filter shadow-xl">
